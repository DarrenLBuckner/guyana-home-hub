...
export default function FSBOApplicationStatus() {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-primary to-primary/80 px-6 py-8 text-white text-center">
            ...
            <p className="text-white/80">FSBO Seller Account</p>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><strong>Account Type:</strong> FSBO Seller</p>
            ...
            {profile?.approval_status === 'needs_correction' && (
              <>
                ...
                <Link
                  href="/dashboard/fsbo/application-status/edit"
                  className="block w-full bg-primary text-white text-center px-6 py-3 rounded-lg hover:bg-primary/90 font-semibold transition-colors"
                >
            ...
            <div className="text-center pt-4 border-t">
              ...
              <p className="text-sm text-gray-600">
                Email: <a href="mailto:support@guyanahomehub.com" className="text-primary hover:underline">support@guyanahomehub.com</a>
                <br />
                WhatsApp: <a href="https://wa.me/5927629797" className="text-primary hover:underline">+592 762 9797</a>
              </p>
            </div>
