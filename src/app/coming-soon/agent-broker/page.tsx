...
export default function ComingSoonAgentBroker() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-8">
      <h1 className="text-4xl font-bold text-green-700 mb-4">Coming Soon: Agent & Broker Services</h1>
      <p className="text-lg text-gray-700 mb-6 max-w-xl text-center">
        Thanks for your interest in joining Guyana Home Hub as an agent or broker! We’re building the most trusted real estate network in Guyana. Our professional tools and lead generation platform are launching soon.
      </p>
      <p className="mb-4 text-gray-600">Want to be first in line? Reach out to us:</p>
      ...
      <div className="mt-8 text-center text-gray-500">
        "Empowering Guyana’s real estate professionals."
      </div>
    </div>
  );
}
