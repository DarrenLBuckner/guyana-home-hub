...
export default function ComingSoonPropertyManager() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-8">
      <h1 className="text-4xl font-bold text-green-700 mb-4">Coming Soon: Property Manager Tools</h1>
      <p className="text-lg text-gray-700 mb-6 max-w-xl text-center">
        Manage multiple properties and tenants with ease. Guyana Home Hub’s property management features are on the way!
      </p>
      <p className="mb-4 text-gray-600">Want early access or have questions? Contact us:</p>
      <div className="flex flex-col items-center gap-2">
        <a href="mailto:info@guyanahomehub.com" className="text-green-700 underline font-medium">info@guyanahomehub.com</a>
        <a
          href="https://wa.me/5927629797?text=Hi%20Guyana%20Home%20Hub%2C%20I'm%20interested%20in%20Property%20Manager%20services."
          target="_blank"
      ...
      <div className="mt-8 text-center text-gray-500">
        "Simplifying property management for Guyana."
      </div>
    </div>
  );
}
